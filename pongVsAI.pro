...
G_AI_Racket_X:=10,
G_AI_Racket_Y:=400,
G_AI_Racket_Speed=G_Racket_Speed_Max,
G_Floor_Y:=500,
G_Ceiling_Y:=10,
...
win_func(paint):-
	...
	line(G_Racket_X, G_Ceiling_Y, G_AI_Racket_X, G_AI_Racket_X, G_AI_Racket_X, G_Floor_Y, G_Racket_X, G_Floor_Y),
...
time_func(end):-
	...
	%(G_X - G_Ball_Radius < G_AI_Racket_X -> G_Speed_X:= -1 * G_Speed_X),
	(G_X - G_Ball_Radius < G_AI_Racket_X ->	
		check_racket(G_AI_Racket_Y,G_AI_Racket_Speed)
	), 
	...
	(G_X + G_Ball_Radius > G_Racket_X-> 
		check_racket(G_Racket_Y,G_Racket_Speed)
	),
	update_window(_).

check_racket(Racket_Y, Racket_Speed):-
	( G_Y + G_Ball_Radius > Racket_Y, G_Y + G_Ball_Radius < Racket_Y + G_Racket_Length -> 
		G_Speed_X:= -1*G_Speed_X,
		G_Spin := Racket_Speed/G_Ball_Radius
	else
		wait(1),
